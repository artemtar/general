...
public class invertible_float_test {/*
    public static void main(String args[]) {
      ...
      System.out.println("Test function init:");
      invertible_float F = new invertible_float();
      F.init();
      F.display("F");
      invertible_float G = new invertible_float();
      G.init();
      G.display("G");
      G = (invertible_float) G.get_inverse();
      System.out.println("Multipl is:");
      invertible_float H = (invertible_float) G.multiply_by(F);
      H.display("H");
      // make wright and check
